...
class ControllerData:
    ...
    @staticmethod
    def normalize():
        ControllerData.joystick1[0] = Math.normalize_neg_one(ControllerData.joystick1[0], 0, 2750)
        ControllerData.joystick1[1] = Math.normalize_neg_one(ControllerData.joystick1[1], 725, 2900)
